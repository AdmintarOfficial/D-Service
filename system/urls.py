...
urlpatterns = [
    ...
    path('สรุปยอดขายประจำเดือน/', views.selling_tomonth, name='Selling-Month'),
    path('สรุปยอดขายประจำเดือน-ปริ้น/', views.selling_tomonth_print, name='Selling-Month-Print'),
    path('ประวัติการขายตามบิล/', views.selling_report, name='Selling-Report'),
